...
var s_account="csaa-montana"

var s_csaa=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
/* Link Tracking Config */
s_csaa.trackDownloadLinks=true
s_csaa.trackExternalLinks=true
s_csaa.trackInlineStats=true
s_csaa.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls"
s_csaa.linkInternalFilters="javascript:,"
s_csaa.linkLeaveQueryString=false
s_csaa.linkTrackVars="None"
s_csaa.linkTrackEvents="None"
/* Plugin Config */
s_csaa.usePlugins=true
function s_csaa_doPlugins(s_csaa) {
	/* Add calls to plugins here */

if(!s_csaa.campaign)
s_csaa.campaign=s_csaa.getQueryParam('cmp,tid',':')
}
s_csaa.doPlugins=s_csaa_doPlugins
/************************** PLUGINS SECTION *************************/
 ...
 */
s_csaa.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t)v+=v?d+t:t;p=p.subs"
+"tring(i==p.length?i:i+1)}return v");
s_csaa.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
s_csaa.p_gvf=new Function("t","k",""
 ...
 */
s_csaa.apl=new Function("L","v","d","u",""
 ...
 */
s_csaa.split=new Function("l","d",""
+"var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x"
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");
/*
 * Plugin: getValOnce 0.2 - get a value once per session or number of days
 */
s_csaa.getValOnce=new Function("v","c","e",""
+"var s=this,k=s.c_r(c),a=new Date;e=e?e:0;if(v){a.setTime(a.getTime("
+")+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v");
/*
 * Plugin: getTimeParting 1.3 - Set timeparting values based on time zone
 */
s_csaa.getTimeParting=new Function("t","z","y",""
 ...
 */
s_csaa.getVisitNum=new Function(""
 ...
 */
s_csaa.getDaysSinceLastVisit=new Function(""
 ...
 */
s_csaa.getPageName=new Function("u",""
...
s_csaa.visitorNamespace="californiastateautomobileassociation"
s_csaa.dc=112
